...
import {cyan500,grey700,blue800,indigo700,red700,deepOrange600,deepPurple800,pink700,lightGreen700} from "material-ui/styles/colors";
...
class newCom extends Component{
    ...
    render(){
        ...
        return (
            <div>
                <div className="indexIntroduction">
                    <h4>云东家商户操作台</h4>
                </div>
                <div className="indexMenu">
                    <ul className="func_ul">
                        <li className="func_ul_li">
                            <div className="func_tag_div">
                                <svg fill={blue800}  viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li className="func_ul_li">
                            <div className="func_tag_div">
                                    <svg fill={lightGreen700} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M0 0h24v24H0z" fill="none"/>
                        ...
                        <li className="func_ul_li" onClick={this.handleClick('pros')}>
                            <div className="func_tag_div">
                                <svg fill={red700} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M0 0h24v24H0z" fill="none"/>
                    ...
                    <ul className="func_ul">
                        <li className="func_ul_li">
                            <div className="func_tag_div">
                                <svg fill={deepPurple800} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M0 0h24v24H0z" fill="none"/>
                        ...
                        <li className="func_ul_li">
                            <div className="func_tag_div">
                                <svg fill={indigo700} viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li className="func_ul_li">
                            <div className="func_tag_div">
                                <svg fill={deepOrange600} height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M0 0h24v24H0z" fill="none"/>
                    ...
                    <ul className="func_ul">
                        <li className="func_ul_li">
                            <div className="func_tag_div">
                                <svg fill={pink700} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M0 0h24v24H0z" fill="none"/>
                ...
                <div className="indexFooter">
                    <p>深圳前海云东家科技有限公司</p>
                    <p>CopyRight Shenzhen QianHaiYunDongJia Tech Co.ltd. (2015-2017)</p>
                </div>
            </div>
        );
    }
